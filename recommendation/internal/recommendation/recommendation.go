...
func (s *Service) Get(ctx context.Context, tripStart, tripEnd time.Time, location string, budget *money.Money) (*Recommendation, error) {
	switch {
	...
	opts, err := s.availability.GetAvailability(ctx, tripStart, tripEnd, location)
	if err != nil {
