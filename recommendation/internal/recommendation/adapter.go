...
func (p *PartnershipAdaptor) GetAvailability(ctx context.Context, tripStart, tripEnd time.Time, location string) ([]Option, error) {
	...
	opts := make([]Option, 0, len(pr.AvailableHotels))
